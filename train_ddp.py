...
parser.add_argument('--batch-size-eval', default=96, type=int,
                    metavar='N',
                    help='mini-batch size (default: 128), this is the total '
                         'batch size of all GPUs on the current node when '
                         'using Data Parallel or Distributed Data Parallel')
...
parser.add_argument('--save_path', default='./result/info', type=str, metavar='PATH',
...
parser.add_argument('--model', default='seresnet50', type=str,
