...
parser.add_argument('--model', default='ViTB-384', type=str,
...
parser.add_argument('--checkpoint',
                    default="/home/hello/cjl/Sample4Geo-main/result/info/ViTB-384/visloc/base/model_best_32_0.8163.pth.tar",
...
# traget_layers = [model.model.stages[2][2].pwconv1]
traget_layers = [model.model.blocks[-1].norm1]
#  2.读取图片，将图片转为RGB
origin_img = cv2.imread("/home/hello/data/UAV-VisLoc/train/drone/06_0289.JPG")[:, :, ::-1]  # 05_0018 01_0409
...
cv2.imwrite('vit_heatmap_06_0289.jpg', visualization_img)
cv2.waitKey(0)
