...
parser.add_argument('--checkpoint',
                    default="/home/hello/cjl/Sample4Geo-main/result/info/vmamba_b/visloc/base_sample/model_best_30_0.7043.pth.tar",
...
traget_layers = [model.model.layers[-1].blocks[-1]]
# traget_layers = [model.model.stages[-1][-1]]
#  2.读取图片，将图片转为RGB
# origin_img = cv2.imread("/home/hello/data/UAV-VisLoc/train/drone/01_0409.JPG")[:,:,::-1]
origin_img = cv2.imread("/home/hello/data/UAV-VisLoc/train/drone/07_0007.JPG")[:, :, ::-1]
