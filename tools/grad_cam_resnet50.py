...
parser.add_argument('--checkpoint',
                    default="/home/hello/cjl/Sample4Geo-main/result/info/resnet50/visloc/base_safa/model_best_29_0.4057.pth.tar",
...
traget_layers = [model.model.features.layer4[-1]]
...
cv2.imwrite('resnet50_heatmap_06_0289.jpg', visualization_img)
cv2.waitKey(0)
