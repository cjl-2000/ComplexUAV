...
from model.dataset.augmentations import RotateAndCrop
...
class DenseUAVTrain(Dataset):
    ...
    def __init__(self,
        ...
        for idx in self.ids:
            for i in range(len(self.query_dict[idx]["files"])):
                ...
                gallery_imgs = self.gallery_dict[idx]["files"][1]
                self.pairs.append((int(idx), query_img, "{}/{}".format(gallery_path, gallery_imgs)))
    ...
    def __getitem__(self, index):
        ...
        # idx, query_img_path, gallery_img_path = self.idx2pair[self.samples[index]]
    ...
    def shuffle_sim(self, sim_dict=None, neighbour_select=64, neighbour_range=128):
    ...
    def __init__(self,
        ...
        for i, sample_id in enumerate(self.ids):
            if self.mode == "query":
                ...
                self.images.append("{}/{}".format(self.data_dict[sample_id]["path"],
                                                  self.data_dict[sample_id]["files"][1]))
...
if __name__ == "__main__":
    ...
    query_folder_train = r'I:\datasets\DenseUAV\train\drone'
    gallery_folder_train = r'I:\datasets\DenseUAV\train\satellite'
    query_folder_test = r'I:\datasets\DenseUAV\test\query_drone'
    gallery_folder_test = r'I:\datasets\DenseUAV\test\gallery_satellite'
    # Train
    train_dataset = DenseUAVTrain(query_folder=query_folder_train,
    ...
    query_dataset_test = DenseUAVEval(data_folder=query_folder_test,
                                      mode="query",
