...
from model.evaluate.eval_cls import evaluate_all
...
parser.add_argument('--model', default='convnext_s', type=str,
...
parser.add_argument('--checkpoint',
                    default="/home/hello/cjl/ComplexUAV-main/result/cls/convnext_b/visloc/adamw_ce_htpl_kl/model_best_30_0.7377.pth.tar",
